package com.giantjason.gulimall.product.entity;
...
public class BrandEntity implements Serializable {
    ...
    @Null(message = "新增时无需指定品牌Id", groups = {AddGroup.class})
    ...
    @Min(value = 0, message = "排序必须是一个大于领的正整数", groups = {AddGroup.class, UpdateGroup.class})
